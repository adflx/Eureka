...
public class DDReticle : MonoBehaviour, IGvrGazePointer
{
                           ...
                           bool isInteractive)
    {
        SetGazeTarget(intersectionPosition, isInteractive);
        gazeAt = targetObject;
        if (gazeAt.tag == "Enemy" || gazeAt.tag == "Asteriod")
        {
            this.GetComponent<Renderer>().material.color = Color.red; this.GetComponent<Renderer>().material.color = Color.red;
        }
    ...
    public void OnGazeTriggerStart(Camera camera)
    {
        ...
        ExecuteEvents.Execute(gazeAt, null, (DragDropHandler handler, BaseEventData data) => handler.HandleGazeTriggerStart());
    ...
    public void OnGazeTriggerEnd(Camera camera)
    {
        ...
        ExecuteEvents.Execute(gazeAt, null, (DragDropHandler handler, BaseEventData data) => handler.HandleGazeTriggerEnd());
